...
school_data_ = "Resources/schools_complete.csv"
...
budget_count = school_data_complete.groupby(['school_name','budget']).sum()
budget_count_reset = budget_count.reset_index()
budget_count_reset
...
total_budget = budget_count_reset["budget"].sum()
total_budget
...
school_data_complete.loc[school_data_complete["math_score"] >=70].count()
# school_passing_math
